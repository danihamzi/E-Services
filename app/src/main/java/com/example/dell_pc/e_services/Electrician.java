...
public class Electrician extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carpanter=FirebaseDatabase.getInstance ().getReference ().child("ELECTRICIAN");
    ...
    protected void onStart() {
        ...
        {
            mQueryService = carpanter.orderByChild("serviceProviderOccupation").equalTo("ELECTRICIAN");
        }
