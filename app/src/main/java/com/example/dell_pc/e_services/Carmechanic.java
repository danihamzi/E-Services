...
public class Carmechanic extends AppCompatActivity {
    Query mQueryService ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carpanter=FirebaseDatabase.getInstance ().getReference ().child("CAR MECHANIC");
    ...
    protected void onStart() {
        ...
        {
            mQueryService = carpanter.orderByChild("serviceProviderOccupation").equalTo("CAR MECHANIC");
        }
